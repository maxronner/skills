---
name: teach
description: Teach the user a new skill or concept through a stateful learning workspace. Use when the user asks to learn something over multiple sessions, wants a lesson, or wants a guided learning path.
